...
const NEWS = [
    ...
    title: "協助彰化縣政府公告轉知各會員：",
    date: "2026-05-25",
    tags: ["公告", "活動"],
    body: "有關「１１５年度彰化縣都市危險及老舊建築物加速重建專業課程講習」招生事宜，敬請詳閱附件報名簡章。",
    attachments: [
      {
        href: "./pdf/縣府115年危老建築加速重建專案課程講習_報名簡章.pdf",
        label: "縣府115年危老建築加速重建專案課程講習_報名簡章",
        size: "PDF",
        canPreview: true
      }
    ]
      ...
      {
    id: "n-2025-09-roster-reps",
    title: "彰化縣總工會「115年度提升勞工自主學習課程」活動公告。",
    date: "2026-01-28",
    tags: ["公告", "活動"],
    body: "鼓勵本會會員善加利用參加。",
    attachments: [
      {
        href: "./pdf/115年度提升勞工自主學習課程.pdf",
        label: "115年度提升勞工自主學習課程",
        size: "PDF",
        canPreview: true
      }
    ]
    ...
    {
    id: "n-2025-09-roster-reps",
    title: "第13屆理監事、名譽理事長、<br>出席上級工會理監事、會務人員名冊",
    date: "2025-12-22",
    tags: ["公告", "選舉"],
    body: "依本會第13屆第2次理監事會議決通過辦理：第13屆理監事、名譽理事長、出席上級工會理監事、會務人員等皆已順利產生並運行，特此公告。",
    attachments: [
      {
        href: "./pdf/第13屆理監事暨上級幹部、會務人員名冊.pdf",
        label: "第13屆理監事暨上級幹部、會務人員名冊",
        size: "PDF",
        canPreview: true
      }
    ]
  ...
  {
    id: "n-2025-09-roster-reps",
    title: "第13屆理事、監事、理事長、監事會召集人當選名冊",
    date: "2025-11-20",
    tags: ["公告", "選舉"],
    body: "本會第13屆理事、監事、理事長、監事會召集人當選名冊，已順利改選產生，特此公告。",
    attachments: [
      {
        href: "./pdf/roster13th.pdf",
        label: "第13屆當選名冊",
        size: "PDF",
        canPreview: true
      }
...
const ANNALS = [
  { year: 114, items: [
    { date: "10月22日", text: "第13屆會員代表、理事、監事、理事長、監事會召集人已改選順利產生，任期自民國114年10月22日起至118年10月21日止。<br><br>備註<br>第13屆：<br>（一）理事長：鄭進成。<br>（二）監事會召集人：陳文欣。" },
  ...
  { year: 80, items: [
    ...
    { date: "5月21日", text: "召開第2屆第1次臨時理監事會，通過購買東民街林氏大樓3樓作為會所，因屋主拒絕出售，無法成交。" },
